...
import hpe.energy_optimization_backend.dto.response.*;
...
public class AuthController {
    ...
    @Operation(
            summary = "Get all users by profile status",
            description = "Retrieves a paginated list of users filtered by profile status and search criteria."
    )
    @ApiResponses({
